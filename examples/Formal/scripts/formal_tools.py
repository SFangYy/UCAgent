...
class ArgGenerateFormalScript(BaseModel):
    ...
    output_file: str = Field(description="Path to output .tcl file")
...
3. Provide output_file: Path to output .tcl file.
4. Provide rtl_dir: Directory containing RTL source.
